...
### CtrlArt d.o.o.
*VR Developer Intern | PAX Training Space Project*
- Developed **VR** application features in **Unity** using C# for **Meta Quest** hardware
- Implemented **object manipulation system**: movement, rotation, snapping, and group management
- Built modular **save system** with **user management** and **game progress** tracking
- Solved Unity **physics synchronization** issues and cross-platform deployment challenges
